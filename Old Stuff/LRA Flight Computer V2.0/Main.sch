...
<library name="Butch Adafruit">
<packages>
<package name="LIS3DH">
<pad name="SDA" x="11.43" y="2.54" drill="1.016"/>
<pad name="SDO" x="13.97" y="2.54" drill="1.016"/>
<pad name="CS" x="16.51" y="2.54" drill="1.016"/>
<pad name="INT" x="19.05" y="2.54" drill="1.016"/>
<pad name="SCL" x="8.89" y="2.54" drill="1.016"/>
<pad name="GND" x="6.35" y="2.54" drill="1.016"/>
<pad name="3.3V" x="3.81" y="2.54" drill="1.016"/>
<pad name="VIN" x="1.27" y="2.54" drill="1.016"/>
<hole x="2.54" y="17.78" drill="2.54"/>
<hole x="17.78" y="17.78" drill="2.54"/>
...
<wire x1="17.78" y1="20.32" x2="20.32" y2="17.78" width="0.127" layer="21" curve="-90"/>
<text x="10.16" y="17.78" size="1.27" layer="21" align="center">LIS3DH</text>
<text x="10.16" y="13.97" size="1.27" layer="21" align="center">16g 3-axis Accel.</text>
</package>
<package name="BMP280">
...
<pad name="CS" x="16.51" y="2.54" drill="1.016"/>
<pad name="SDI" x="13.97" y="2.54" drill="1.016"/>
<pad name="SDO" x="11.43" y="2.54" drill="1.016"/>
<pad name="SCK" x="8.89" y="2.54" drill="1.016"/>
<pad name="GND" x="6.35" y="2.54" drill="1.016"/>
<pad name="3.3V" x="3.81" y="2.54" drill="1.016"/>
<pad name="VIN" x="1.27" y="2.54" drill="1.016"/>
<hole x="2.54" y="16.51" drill="2.54"/>
<hole x="15.24" y="16.51" drill="2.54"/>
<text x="8.89" y="15.24" size="1.27" layer="21" align="center">BMP280
Pressure
Temperature</text>
</package>
</packages>
<symbols>
<symbol name="LIS3DH">
<pin name="INT" x="-17.78" y="25.4" length="middle"/>
<pin name="CS" x="-17.78" y="22.86" length="middle"/>
<pin name="SDO/MISO" x="-17.78" y="20.32" length="middle"/>
<pin name="SDA/MOSI" x="-17.78" y="17.78" length="middle"/>
<pin name="SCL/CLK" x="-17.78" y="15.24" length="middle"/>
...
<pin name="SDI/MOSI" x="-10.16" y="7.62" length="middle"/>
<pin name="SDO/MISO" x="-10.16" y="5.08" length="middle"/>
...
<gates>
<gate name="A" symbol="LIS3DH" x="5.08" y="-7.62"/>
</gates>
<devices>
...
<connect gate="A" pin="SCL/CLK" pad="SCL"/>
<connect gate="A" pin="SDA/MOSI" pad="SDA"/>
<connect gate="A" pin="SDO/MISO" pad="SDO"/>
...
<gates>
<gate name="G$1" symbol="BMP280" x="-7.62" y="7.62"/>
</gates>
<devices>
...
<part name="U$2" library="Butch Adafruit" deviceset="LIS3DH" device=""/>
<part name="U$3" library="Butch Adafruit" deviceset="BMP280" device=""/>
<part name="SWITCH" library="SparkFun-Connectors" deviceset="CONN_02" device="-JST-2-PTH-NO_SILK"/>
<part name="BATT" library="SparkFun-Connectors" deviceset="CONN_02" device="-JST-2-PTH-NO_SILK"/>
<part name="5VREG" library="78xx_with_heatsink" deviceset="78XXH" device=""/>
<part name="RADIO_MODULE" library="SparkFun-Connectors" deviceset="CONN_09" device=""/>
<part name="RADIO_AUX" library="SparkFun-Connectors" deviceset="CONN_05" device=""/>
...
<sheet>
<plain>
<text x="48.26" y="93.98" size="1.016" layer="91">accel</text>
<text x="165.1" y="83.82" size="1.016" layer="91">pressure
temp</text>
<text x="78.74" y="15.24" size="1.016" layer="91" align="center">Actually
3.5</text>
<text x="170.18" y="-25.4" size="1.778" layer="91" align="center-left">Pins to route to 
pin bus:
1) BATT_IN
2) S_GND
3) RX1
...
15) 30
16 - 19) 20 - 23
20) GND (From BATT/Switch. This is for the altimeter switches)
</text>
</plain>
<instances>
<instance part="U$1" gate="G$1" x="96.52" y="-17.78"/>
<instance part="U$2" gate="A" x="73.66" y="73.66"/>
<instance part="U$3" gate="G$1" x="152.4" y="93.98" rot="R180"/>
<instance part="SWITCH" gate="G$1" x="-17.78" y="58.42"/>
<instance part="BATT" gate="G$1" x="-17.78" y="40.64"/>
<instance part="5VREG" gate="A" x="30.48" y="40.64"/>
<instance part="RADIO_MODULE" gate="G$1" x="170.18" y="53.34" rot="R180"/>
<instance part="RADIO_AUX" gate="G$1" x="167.64" y="27.94" rot="R180"/>
...
<segment>
<pinref part="5VREG" gate="A" pin="GND"/>
...
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="8"/>
...
<segment>
<pinref part="U$2" gate="A" pin="SDO/MISO"/>
...
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="4"/>
...
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="3"/>
...
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="5"/>
...
<net name="5V" class="0">
<segment>
<pinref part="5VREG" gate="A" pin="OUT"/>
...
<label x="124.46" y="-5.08" size="1.016" layer="95" xref="yes"/>
</segment>
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="9"/>
...
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="1"/>
...
<net name="G0" class="0">
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="6"/>
...
<net name="EN" class="0">
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="7"/>
...
<segment>
<pinref part="RADIO_MODULE" gate="G$1" pin="2"/>
...
<segment>
<pinref part="5VREG" gate="A" pin="IN"/>
...
<label x="-7.62" y="-25.4" size="1.016" layer="95" xref="yes"/>
</segment>
</net>
<net name="A2" class="0">
<segment>
